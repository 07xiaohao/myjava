...
import com.bjpn.controller.UserController;
...
class UserServiceApplicationTests {
    ...
    @Test
    void contextLoads() {
        UserService o = (UserService) Proxy.newProxyInstance(UserController.class.getClassLoader(), new Class[]{UserService.class}, new InvocationHandler () {
